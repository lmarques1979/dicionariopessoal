...
class gsp_dicionariopessoal_regraedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(regraInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(regraInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(regraInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:regraInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
