...
class gsp_dicionariopessoal_usuarioRegraedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(usuarioRegraInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(usuarioRegraInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(usuarioRegraInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:usuarioRegraInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
