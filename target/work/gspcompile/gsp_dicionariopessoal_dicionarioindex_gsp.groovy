...
class gsp_dicionariopessoal_dicionarioindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dicionario/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(10)
invokeTag('message','g',26,['code':("dicionario.destino.label"),'default':("Destino")],-1)
printHtmlPart(11)
loop:{
int i = 0
for( dicionarioInstance in (dicionarioInstanceList) ) {
printHtmlPart(12)
expressionOut.print((i % 2) == 0 ? 'even' : 'odd')
printHtmlPart(13)
createTagBody(3, {->
expressionOut.print(fieldValue(bean: dicionarioInstance, field: "nome"))
})
invokeTag('link','g',34,['action':("show"),'id':(dicionarioInstance.id)],3)
printHtmlPart(14)
...
printHtmlPart(16)
invokeTag('paginate','g',45,['total':(dicionarioInstanceCount ?: 0)],-1)
printHtmlPart(17)
})
