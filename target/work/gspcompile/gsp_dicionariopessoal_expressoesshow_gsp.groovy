...
invokeTag('link','g',60,['class':("edit"),'action':("edit"),'resource':(expressoesInstance)],3)
printHtmlPart(19)
...
invokeTag('form','g',63,['url':([resource:expressoesInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1424711283000L
