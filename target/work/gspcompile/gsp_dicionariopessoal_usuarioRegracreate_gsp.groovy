...
class gsp_dicionariopessoal_usuarioRegracreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(usuarioRegraInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(usuarioRegraInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:usuarioRegraInstance, action:'save'])],2)
printHtmlPart(22)
})
