...
class gsp_dicionariopessoal_usuariocreate_gsp extends GroovyPage {
...
printHtmlPart(16)
invokeTag('submitButton','g',25,['name':("create"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(7)
})
invokeTag('uploadForm','g',26,['url':([resource:usuarioInstance, action:'save'])],2)
printHtmlPart(17)
})
