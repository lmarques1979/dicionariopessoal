...
class gsp_dicionariopessoal_regracreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(regraInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(regraInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:regraInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1422987965000L
